...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/prov-insights.js --list-insight-skills
```
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/prov-insights.js --correlate .provenmap/monitoring/signals.json --out .provenmap/monitoring/skeleton.json
```
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/prov-insights.js --save-insight .provenmap/monitoring/skeleton.json --board-slug <boardSlug> --require-pack --push
```
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/prov-insights.js --save-insight .provenmap/monitoring/skeleton.json --board-slug <boardSlug> --require-pack --push --propose-intents
```
