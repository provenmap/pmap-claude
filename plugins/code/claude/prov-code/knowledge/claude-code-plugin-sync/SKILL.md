...
**Invocation:**
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/prov-sync.js [options]
```
...
**Invocation:**
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/prov-archetypes.js [options]
```
...
**Invocation:**
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/prov-boards.js [options]
```
