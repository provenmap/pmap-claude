...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/prov-insights.js --get-insight-skill <slug>
```
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/prov-context-tags.js
```
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/prov-insights.js --save-insight <path> --board-slug <primaryBoardSlug> --push
```
