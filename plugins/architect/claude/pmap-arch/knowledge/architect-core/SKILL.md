...
- `node ${CLAUDE_PLUGIN_ROOT}/scripts/pmap-arch.js --classify-tree [--refresh]` — the taxonomy
...
- `node ${CLAUDE_PLUGIN_ROOT}/scripts/pmap-arch.js --attention` — the ranked attention queue +
